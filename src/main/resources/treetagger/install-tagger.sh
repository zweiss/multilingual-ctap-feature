...
if [ -r english-bnc-par-linux-3.2-utf8.bin.gz ]
then
    gzip -cd english-bnc-par-linux-3.2-utf8.bin.gz > lib/english-utf8.par
    echo 'English BNC parameter file (UTF8) installed.'
fi
...
if [ -r english-bnc-par-linux-3.2-utf8.bin ]
then
    mv english-bnc-par-linux-3.2-utf8.bin lib/english-utf8.par
    echo 'English BNC parameter file (UTF8) installed.'
fi
