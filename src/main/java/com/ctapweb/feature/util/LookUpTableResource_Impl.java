...
public class LookUpTableResource_Impl implements LookUpTableResource,
	...
	public void load(DataResource aData) throws ResourceInitializationException {
		...
		logger.trace(LogMarker.UIMA_MARKER, new LoadResourceMessage(
				RESOURCE_KEY, aData.getUrl().toString()));
	...
	public boolean containsWord(String word) {
		return lookUpTable.containsKey(word);
	}
}
