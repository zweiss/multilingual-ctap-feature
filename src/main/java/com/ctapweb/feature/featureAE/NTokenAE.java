...
public class NTokenAE extends JCasAnnotator_ImplBase {
	...
	private static final String aeName = "NToken Feature Extractor";
	...
	public void process(JCas aJCas) throws AnalysisEngineProcessException {
		...
		while(it.hasNext()) {
			...
			if(excludePunct && token.getCoveredText().matches("\\p{Punct}")) {
				continue;
			} else {
				occurrence++;
			}
		...
		NToken annotation = new NToken(aJCas);
